...
public class DriveTrain {
    ...
    public static SwerveDrive create(Gyro gyro) throws IllegalArgumentException {
        return new SwerveDrive.Builder()
                ...
                .setModuleMap((map) -> {
                    map.put(SwerveModule.Location.FRONT_RIGHT, new MK3SwerveModule(frontRightDriveCanId,
                            frontRightPivotCanId, frontRightEncoder, frontRightAngleOffset));
                    map.put(SwerveModule.Location.FRONT_LEFT, new MK3SwerveModule(frontLeftDriveCanId,
                            frontLeftPivotCanId, frontLeftEncoder, frontLeftAngleOffset));
                    map.put(SwerveModule.Location.REAR_LEFT, new MK3SwerveModule(rearLeftDriveCanId, rearLeftPivotCanId,
                            rearLeftEncoder, rearLeftAngleOffset));
                    map.put(SwerveModule.Location.REAR_RIGHT, new MK3SwerveModule(rearRightDriveCanId,
                            rearRightPivotCanId, rearRightEncoder, rearRightAngleOffset));
